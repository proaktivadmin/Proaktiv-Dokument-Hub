# FRONTEND SPECIFICATION - V3.0 Document Hub

**Generated by:** Frontend Architect Agent  
**Date:** 2026-01-17  
**Phase:** 3.0 (Office & Employee Hub + Assets + Territory Map)

---

## EXECUTIVE SUMMARY

This specification defines the frontend architecture for V3.0 features, building upon the existing V2.9 production system. The implementation adds organizational management (offices, employees), company assets with scoped storage, territory mapping, enhanced Vitec categories, and system template versioning.

### Current Frontend State (V2.9) - PRODUCTION LIVE

| Component | Status | Notes |
|-----------|--------|-------|
| Next.js 14 App Router | ✅ | Server + Client Components |
| Shadcn/UI Components | ✅ | Full design system |
| Shelf-based Template Library | ✅ | Grouped by channel |
| 4-Tab Template Viewer | ✅ | Preview, Code, Settings, Simulator |
| Flettekoder (Merge Fields) Page | ✅ | Search, categories, code generator |
| Storage Browser | ✅ | WebDAV integration |
| Authentication | ✅ | JWT sessions, login page |
| Dashboard | ✅ | Stats + Inventory sync status |
...
│ Header (existing)                                                │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Kontorer                                │
│                                                                  │
│ ┌────────────────────────┐  ┌──────────────┐  ┌──────────────┐ │
│ │ 🔍 Søk kontorer...     │  │ Filter: By   ▼│  │ + Nytt kontor│ │
│ └────────────────────────┘  └──────────────┘  └──────────────┘ │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Office Grid (3 columns)                                      │ │
│ │ ┌───────────┐ ┌───────────┐ ┌───────────┐                   │ │
│ │ │ STAV      │ │ SANDNES   │ │ OSLO      │                   │ │
│ │ │ Stavanger │ │ Sandnes   │ │ Oslo      │                   │ │
│ │ │ 🟢 Active │ │ 🟢 Active │ │ 🟡 Setup  │                   │ │
│ │ │ 8 ansatte │ │ 5 ansatte │ │ 2 ansatte │                   │ │
│ │ └───────────┘ └───────────┘ └───────────┘                   │ │
│ └─────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
│ Header                                                           │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Kontorer > Proaktiv Stavanger           │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Office Header                                                │ │
│ │ ┌──────┐  Proaktiv Stavanger            [Rediger] [Deaktiver]│ │
│ │ │ LOGO │  Stavanger | 🟢 Aktiv                               │ │
│ │ └──────┘  ✉ stavanger@proaktiv.no | 📞 51 00 00 00          │ │
│ └─────────────────────────────────────────────────────────────┘ │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Tabs: [Ansatte] [Filer] [Markedsområde] [Eksterne lenker]   │ │
│ │                                                              │ │
│ │ TabContent (Ansatte):                                        │ │
│ │ ┌───────────────────────────────────────────────────────────┐│ │
│ │ │ + Ny ansatt                          Filter: Status ▼     ││ │
│ │ │                                                           ││ │
│ │ │ Employee Grid (similar to office grid)                    ││ │
│ │ │ ┌─────────┐ ┌─────────┐ ┌─────────┐                      ││ │
│ │ │ │ Photo   │ │ Photo   │ │ Photo   │                      ││ │
│ │ │ │ Name    │ │ Name    │ │ Name    │                      ││ │
│ │ │ │ Title   │ │ Title   │ │ Title   │                      ││ │
...
| Markedsområde | `TerritoryMiniMap` | Postal codes this office covers |
...
│ Header                                                           │
├───────────────────────────────────────────────────────────────── │
│ Breadcrumb: Dashboard > Ansatte                                  │
│                                                                  │
│ ┌────────────────┐ ┌─────────────────────────────────────────┐ │
│ │ Office Sidebar │ │ Employee Grid                           │ │
│ │                │ │                                          │ │
│ │ Alle kontorer  │ │ ┌─────────┐ ┌─────────┐ ┌─────────┐    │ │
│ │ ───────────────│ │ │ Avatar  │ │ Avatar  │ │ Avatar  │    │ │
│ │ ○ Stavanger (8)│ │ │ Per     │ │ Kari    │ │ Ole     │    │ │
│ │ ○ Sandnes (5)  │ │ │ Megler  │ │ Megler  │ │ Oppgjør │    │ │
│ │ ○ Oslo (2)     │ │ │ 🟢 Aktiv│ │ 🟢 Aktiv│ │ 🟡 Onb. │    │ │
│ │                │ │ └─────────┘ └─────────┘ └─────────┘    │ │
│ │ Filter: Status │ │                                          │ │
│ │ ───────────────│ │                                          │ │
│ │ ☑ Aktiv       │ │                                          │ │
...
│ Header                                                           │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Ansatte > Per Hansen                    │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Profile Header                                               │ │
│ │ ┌──────────┐                                                 │ │
│ │ │ AVATAR   │  Per Hansen          [Rediger] [Start offboard.]│ │
│ │ │   PH     │  Eiendomsmegler MNEF                            │ │
│ │ └──────────┘  Proaktiv Stavanger | 🟢 Aktiv siden 01.01.2020 │ │
│ │               ✉ per@proaktiv.no | 📞 912 34 567              │ │
│ └─────────────────────────────────────────────────────────────┘ │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Tabs: [Oversikt] [Filer] [Sjekklister] [Eksterne lenker]    │ │
│ │                                                              │ │
│ │ TabContent (Oversikt):                                       │ │
│ │ ┌────────────────────────┐ ┌────────────────────────┐       │ │
│ │ │ Kontaktinfo            │ │ Nettsider              │       │ │
│ │ │ E-post: per@...        │ │ 🔗 Hjemmeside profil   │       │ │
│ │ │ Telefon: 912 34 567    │ │ 🔗 LinkedIn            │       │ │
│ │ └────────────────────────┘ └────────────────────────┘       │ │
│ │                                                              │ │
│ │ ┌──────────────────────────────────────────────────────────┐│ │
│ │ │ Ansettelsesforhold                                       ││ │
...
│ Skjules fra hjemmeside: 15.03.2026                             │
│ Slett data: 30.04.2026                                         │
│                                                                 │
│ Sjekkliste: 3/7 fullført                ━━━━━━━━━░░░░░░░░░░░░░ │
│                                                                 │
│ [Se full sjekkliste →]                                         │
└────────────────────────────────────────────────────────────────┘
```
...
│ Header                                                           │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Filer                                   │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Tabs: [Globalt] [Per kontor] [Per ansatt]                   │ │
│ │                                                              │ │
│ │ Category Filter:                                             │ │
│ │ [Alle] [Logo] [Foto] [Markedsføring] [Dokumenter]           │ │
│ │                                                              │ │
│ │ Asset Grid:                                  [+ Last opp fil]│ │
│ │ ┌─────────┐ ┌─────────┐ ┌─────────┐ ┌─────────┐            │ │
│ │ │ 🖼      │ │ 🖼      │ │ 📄      │ │ 🖼      │            │ │
│ │ │ Logo    │ │ Logo    │ │ Brosjyre│ │ Banner  │            │ │
│ │ │ Primary │ │ White   │ │ PDF     │ │ Web     │            │ │
│ │ │ 245 KB  │ │ 180 KB  │ │ 2.1 MB  │ │ 890 KB  │            │ │
│ │ └─────────┘ └─────────┘ └─────────┘ └─────────┘            │ │
│ └─────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
### Page 6: `/territories` - Territory Map (Markedsområde)
...
│ Header                                                           │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Markedsområde                           │
│                                                                  │
│ ┌──────────────────────────┐ ┌────────────────────────────────┐ │
│ │ Layer Controls           │ │ Interactive Map (Leaflet)      │ │
│ │                          │ │                                 │ │
│ │ Lag:                     │ │     ┌───────────────────────┐  │ │
│ │ ☑ Vitec Next (master)   │ │     │   ████  ████  ████   │  │ │
│ │ ☐ Finn.no               │ │     │ ████████████████████ │  │ │
...
│ │                          │ │     └───────────────────────┘  │ │
│ │ Kontorer:                │ │                                 │ │
│ │ ● Stavanger (#4A90D9)   │ │  Legend:                        │ │
│ │ ● Sandnes (#E67E22)     │ │  ● Stavanger  ● Sandnes         │ │
│ │ ● Oslo (#9B59B6)        │ │  ● Oslo       ⬛ Svartelistet    │ │
│ │                          │ │                                 │ │
│ │ [Importer postnumre →]  │ │                                 │ │
│ └──────────────────────────┘ └────────────────────────────────┘ │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Postal Code Table (below map)                                │ │
│ │ Postnr | Poststed    | Kontor    | Kilde     | Prioritet   │ │
│ │ 4000   | Stavanger   | Stavanger | vitec_next| 1           │ │
│ │ 4001   | Stavanger   | Stavanger | vitec_next| 1           │ │
│ │ ...                                                          │ │
│ └─────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
│ Header                                                           │
├─────────────────────────────────────────────────────────────────┤
│ Breadcrumb: Dashboard > Systemmaler                             │
│                                                                  │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ Tabs: [Topptekster] [Bunntekster] [Signaturer] [Stilark]    │ │
│ │                                                              │ │
│ │ Partial Grid:                               [+ Ny topptekst] │ │
│ │ ┌────────────────────────────────────────────────────────┐  │ │
│ │ │ Standard PDF Header           v3          [★ Default]   │  │ │
│ │ │ Brukes i: pdf, email                                    │  │ │
│ │ │ Sist endret: 2 dager siden                             │  │ │
│ │ │                                    [Historikk] [Rediger]│  │ │
│ │ └────────────────────────────────────────────────────────┘  │ │
│ │                                                              │ │
│ │ ┌────────────────────────────────────────────────────────┐  │ │
│ │ │ Kontraktsdokument Header      v1                        │  │ │
│ │ │ Brukes i: Kontraktsmaler                               │  │ │
│ │ │ Sist endret: 5 dager siden                             │  │ │
│ │ │                                    [Historikk] [Rediger]│  │ │
│ │ └────────────────────────────────────────────────────────┘  │ │
│ └─────────────────────────────────────────────────────────────┘ │
└─────────────────────────────────────────────────────────────────┘
...
// Layout:
// ┌─────────────────────────────────────────────┐
// │ Versjonshistorikk: Standard PDF Header      │
// │                                             │
// │ ● v3 (gjeldende)           2 dager siden   │
// │   "Oppdatert logo og farger"               │
// │   av system                                 │
// │                                             │
// │ ○ v2                       1 uke siden      │
// │   "Lagt til telefonnummer"     [Gjenopprett]│
// │   av system                                 │
// │                                             │
// │ ○ v1                       2 uker siden     │
// │   "Første versjon"             [Gjenopprett]│
// │   av system                                 │
// └─────────────────────────────────────────────┘
```
...
// ┌─────────────────────────────────────────────────────────────────┐
// │ 3 maler valgt    [Status ▼] [Kategori ▼] [Arkiver] [Avbryt]   │
// └─────────────────────────────────────────────────────────────────┘
```
...
│   ├── OfficeGrid.tsx
│   ├── OfficeHeader.tsx
│   ├── OfficeForm.tsx (dialog for create/edit)
│   └── index.ts
├── employees/
│   ├── EmployeeCard.tsx
│   ├── EmployeeGrid.tsx
...
├── territories/
│   ├── TerritoryMap.tsx
│   ├── TerritoryMiniMap.tsx (for office detail)
│   ├── LayerControls.tsx
│   ├── PostalCodeTable.tsx
│   ├── ImportTerritoryDialog.tsx
│   └── index.ts
├── checklists/
│   ├── ChecklistProgress.tsx
│   ├── ChecklistItemRow.tsx
│   ├── ChecklistAssignDialog.tsx
│   ├── ChecklistTemplateEditor.tsx
│   └── index.ts
├── external-listings/
│   ├── ExternalListingTable.tsx
│   ├── ExternalListingForm.tsx
...
│   ├── DefaultRulesPanel.tsx
│   └── index.ts
└── bulk/
    ├── BulkActionToolbar.tsx
    ├── BulkStatusDialog.tsx
    ├── BulkCategoryDialog.tsx
    └── index.ts
```
...
const navigationItems = [
  ...
  { href: '/territories', label: 'Markedsområde', icon: Map },
...
2. Offices → Employees → Assets (chain dependency)
