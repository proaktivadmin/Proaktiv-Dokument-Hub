...
class LayoutPartialVersionBase(BaseModel):
    ...
    change_notes: str | None = Field(None, description="Notes about changes in this version")
...
class LayoutPartialDefaultBase(BaseModel):
    ...
    category_id: UUID | None = Field(None, description="Category ID (if scope='category')")
    medium: Medium | None = Field(None, description="Medium (if scope='medium')")
...
class LayoutPartialDefaultWithDetails(LayoutPartialDefaultResponse):
    ...
    category: CategoryMinimal | None = None
