...
class OfficeTerritory(Base):
    ...
    postal_code: Mapped[str] = mapped_column(
        String(10), ForeignKey("postal_codes.postal_code", ondelete="CASCADE"), nullable=False
    )

    # Source and priority
    source: Mapped[str] = mapped_column(
        String(50), nullable=False, default="vitec_next"
    ...
    # Relationships
    office: Mapped["Office"] = relationship("Office", back_populates="territories")

    postal_code_info: Mapped["PostalCode"] = relationship("PostalCode", back_populates="territories")
    ...
    def __repr__(self) -> str:
        return (
            f"<OfficeTerritory(office_id={self.office_id}, postal_code='{self.postal_code}', source='{self.source}')>"
        )
