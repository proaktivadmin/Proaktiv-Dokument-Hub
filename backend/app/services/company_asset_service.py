...
from app.schemas.company_asset import CompanyAssetCreate, CompanyAssetUpdate, AssetMetadata
...
class CompanyAssetService:
    ...
    async def list(
        ...
        *,
        ...
        query = select(CompanyAsset).options(
            selectinload(CompanyAsset.office),
            selectinload(CompanyAsset.employee)
        )
    ...
    @staticmethod
    async def get_by_id(db: AsyncSession, asset_id: UUID) -> Optional[CompanyAsset]:
        """
    ...
    async def get_by_office(
        ...
        *,
        ...
        Returns:
            List of assets
        """
        query = select(CompanyAsset).where(
            CompanyAsset.office_id == str(office_id)
        )
    ...
    async def get_by_employee(
        ...
        *,
        ...
        """
        query = select(CompanyAsset).where(
            CompanyAsset.employee_id == str(employee_id)
        )
