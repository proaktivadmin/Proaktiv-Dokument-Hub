...
class ChecklistTemplateService:
    ...
    @staticmethod
    async def get_by_id(db: AsyncSession, template_id: UUID) -> Optional[ChecklistTemplate]:
        """Get a template by ID."""
        result = await db.execute(
            select(ChecklistTemplate).where(ChecklistTemplate.id == str(template_id))
        )
    ...
    @staticmethod
    async def deactivate(db: AsyncSession, template_id: UUID) -> Optional[ChecklistTemplate]:
...
class ChecklistInstanceService:
    ...
    async def list(
        ...
        *,
        ...
        query = select(ChecklistInstance).options(
            ...
            selectinload(ChecklistInstance.employee)
        )
    ...
    @staticmethod
    async def get_by_id(db: AsyncSession, instance_id: UUID) -> Optional[ChecklistInstance]:
    ...
    @staticmethod
    async def cancel(db: AsyncSession, instance_id: UUID) -> Optional[ChecklistInstance]:
    ...
    async def get_by_employee(
        ...
        *,
        ...
        query = select(ChecklistInstance).options(
            ...
            ChecklistInstance.employee_id == str(employee_id)
        )
