...
CATEGORIES = [
    ...
    {'name': 'AML', 'icon': 'Shield', 'description': 'Anti-hvitvaskingsdokumenter og risikovurderinger', 'sort_order': 2},
    ...
    {'name': 'Forretningsfører', 'icon': 'Building', 'description': 'Kommunikasjon med forretningsfører', 'sort_order': 6},
    {'name': 'Informasjonsbrev', 'icon': 'Info', 'description': 'Informasjonsbrev til kjøper og selger', 'sort_order': 7},
