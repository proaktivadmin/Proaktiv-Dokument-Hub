...
def import_templates(api_url: str, templates: List[Dict[str, Any]], dry_run: bool = False) -> None:
    ...
    for template in templates:
        try:
            ...
            files = {
                'file': (template['file_name'], content, 'text/html')
            }
            data = {
...
def main():
    ...
    parser.add_argument('--api-url', required=True, help='API base URL (e.g., https://proaktiv-dokument-hub-production.up.railway.app)')
