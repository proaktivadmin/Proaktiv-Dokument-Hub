      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statsLoading ? (
            ...
            <>
              <div className="bg-primary text-primary-foreground rounded-lg p-6 shadow-lg">
                <p className="text-primary-foreground/80 text-sm">Totalt maler</p>
                <p className="text-3xl font-bold mt-1">{stats?.total_templates ?? 0}</p>
              </div>

              <div className="bg-card rounded-lg p-6 shadow-sm border">
                <p className="text-muted-foreground text-sm">Publiserte</p>
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border">
                <p className="text-muted-foreground text-sm">Utkast</p>
            ...
            <div className="space-y-2">
              {stats.recent_uploads.map((upload) => (
                ...
                >
                  ...
                  <span className="text-muted-foreground/70">ble lastet opp</span>
